...
// 迷子検知用のiBeaconUUID
#define LOST_BEACON_UUID "e2c56db5-dffb-48d2-b060-d0f5a71096e1"
...
void bt_read() {
    ...
    ble112.ble_cmd_gatt_server_send_user_read_response(1, 0x000C, 0, sendLen, (const uint8 *)sendData);
    while (ble112.checkActivity(1000));
}
...
void StartiBeaconAdvData() {
    ...
    uint8_t adv_data[] = {
        ...
        // UUID
        uuid_bytes[0], uuid_bytes[1], uuid_bytes[2], uuid_bytes[3], uuid_bytes[4], uuid_bytes[5], uuid_bytes[6], uuid_bytes[7], uuid_bytes[8], uuid_bytes[9], uuid_bytes[10], uuid_bytes[11],
    ...
    while (ble112.checkActivity(1000));
    // index = 0  LE_GAP_SCANNABLE_NON_CONNECTABLE /
